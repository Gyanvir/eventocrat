    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-6 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl font-bold mb-4 flex items-center gap-2">🏢 Company Dashboard</h1>
          ...
          <h2 className="text-2xl font-semibold mt-6 mb-3">📬 Available Events to Sponsor</h2>
